...
list(APPEND _cmake_import_check_files_for_OpenEXR::openjph "${_IMPORT_PREFIX}/lib/openjph.0.24.lib" "${_IMPORT_PREFIX}/bin/openjph.0.24.dll" )
...
set_target_properties(OpenEXR::Iex PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/Iex-3_4.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/Iex-3_4.dll"
  )

list(APPEND _cmake_import_check_targets OpenEXR::Iex )
list(APPEND _cmake_import_check_files_for_OpenEXR::Iex "${_IMPORT_PREFIX}/lib/Iex-3_4.lib" "${_IMPORT_PREFIX}/bin/Iex-3_4.dll" )
...
set_target_properties(OpenEXR::IlmThread PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/IlmThread-3_4.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/IlmThread-3_4.dll"
  )

list(APPEND _cmake_import_check_targets OpenEXR::IlmThread )
list(APPEND _cmake_import_check_files_for_OpenEXR::IlmThread "${_IMPORT_PREFIX}/lib/IlmThread-3_4.lib" "${_IMPORT_PREFIX}/bin/IlmThread-3_4.dll" )
...
set_target_properties(OpenEXR::OpenEXRCore PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/OpenEXRCore-3_4.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "OpenEXR::openjph"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/OpenEXRCore-3_4.dll"
  )

list(APPEND _cmake_import_check_targets OpenEXR::OpenEXRCore )
list(APPEND _cmake_import_check_files_for_OpenEXR::OpenEXRCore "${_IMPORT_PREFIX}/lib/OpenEXRCore-3_4.lib" "${_IMPORT_PREFIX}/bin/OpenEXRCore-3_4.dll" )
...
set_target_properties(OpenEXR::OpenEXR PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/OpenEXR-3_4.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/OpenEXR-3_4.dll"
  )

list(APPEND _cmake_import_check_targets OpenEXR::OpenEXR )
list(APPEND _cmake_import_check_files_for_OpenEXR::OpenEXR "${_IMPORT_PREFIX}/lib/OpenEXR-3_4.lib" "${_IMPORT_PREFIX}/bin/OpenEXR-3_4.dll" )
...
set_target_properties(OpenEXR::OpenEXRUtil PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/OpenEXRUtil-3_4.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/OpenEXRUtil-3_4.dll"
  )

list(APPEND _cmake_import_check_targets OpenEXR::OpenEXRUtil )
list(APPEND _cmake_import_check_files_for_OpenEXR::OpenEXRUtil "${_IMPORT_PREFIX}/lib/OpenEXRUtil-3_4.lib" "${_IMPORT_PREFIX}/bin/OpenEXRUtil-3_4.dll" )
