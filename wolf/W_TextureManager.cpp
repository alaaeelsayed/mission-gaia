...
namespace wolf
{
	...
	//----------------------------------------------------------
	Texture *TextureManager::CreateTexture(void *pData, unsigned int width, unsigned int height, Texture::Format internalFmt, Texture::Format fmt)
	{
		return new Texture(pData, width, height, internalFmt, fmt);
	}
