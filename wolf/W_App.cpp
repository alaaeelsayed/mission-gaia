...
namespace wolf
{
    ...
    void App::run()
    {
        ...
        while (!glfwWindowShouldClose(m_pWindow) && !isKeyDown(192))
        {
    ...
    void App::setInputMode(GLuint cursor, GLuint cursorAction)
    {
        glfwSetInputMode(m_pWindow, cursor, cursorAction);
    }

    void App::setCursorPosCallback(GLFWcursorposfun callback)
    {
        glfwSetCursorPosCallback(m_pWindow, callback);
    }

    void App::setCursorPos(double xpos, double ypos)
    {
