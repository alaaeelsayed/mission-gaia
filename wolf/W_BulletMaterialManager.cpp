...
#include "../tinyxml2/tinyxml2.h" // For parsing material XML
...
void BulletPhysicsMaterialManager::LoadMaterials(const std::string &p_strMaterialPath)
{
    ...
    if (doc.LoadFile(p_strMaterialPath.c_str()) == tinyxml2::XML_SUCCESS)
    {
