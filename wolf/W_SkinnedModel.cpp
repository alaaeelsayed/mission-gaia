...
namespace wolf
{
    ...
    void SkinnedModel::_readNodeHierarchy(const aiScene *pScene, MeshNode *pMeshNode, float animationTime, const aiNode *pNode, const aiMatrix4x4 &parentTransform)
    {
        ...
        const aiAnimation *pAnimation = pScene->mAnimations[1];
    ...
    void SkinnedModel::_calcInterpolatedScaling(aiVector3D &out, float animationTime, const aiNodeAnim *pNodeAnim)
    {
        ...
        unsigned int ScalingIndex = _findScaling(animationTime, pNodeAnim);
    ...
    void SkinnedModel::_calcInterpolatedPosition(aiVector3D &out, float animationTime, const aiNodeAnim *pNodeAnim)
    {
        ...
        unsigned int PositionIndex = _findPosition(animationTime, pNodeAnim);
    ...
    void SkinnedModel::_calcInterpolatedRotation(aiQuaternion &out, float animationTime, const aiNodeAnim *pNodeAnim)
    {
        ...
        unsigned int RotationIndex = _findRotation(animationTime, pNodeAnim);
    ...
    unsigned int SkinnedModel::_findScaling(float animationTime, const aiNodeAnim *pNodeAnim)
    {
    ...
    unsigned int SkinnedModel::_findPosition(float animationTime, const aiNodeAnim *pNodeAnim)
    {
    ...
    unsigned int SkinnedModel::_findRotation(float animationTime, const aiNodeAnim *pNodeAnim)
    {
