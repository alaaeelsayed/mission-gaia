...
namespace wolf
{
    ...
    protected:
        ...
        unsigned int _findScaling(float animationTime, const aiNodeAnim *pNodeAnim);
        unsigned int _findPosition(float animationTime, const aiNodeAnim *pNodeAnim);
        unsigned int _findRotation(float animationTime, const aiNodeAnim *pNodeAnim);
