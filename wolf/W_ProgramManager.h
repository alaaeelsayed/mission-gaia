...
namespace wolf
{
	...
	public:
		...
		// PUBLIC INTERFACE
		//-------------------------------------------------------------------------
		static Program *CreateProgram(const std::string &vsFile, const std::string &fsFile); // For non-compute shaders
		static Program *CreateProgram(const std::string &sFile, GLenum shaderType);			 // For compute shaders
	...
	private:
		...
		// PRIVATE MEMBERS
		//-------------------------------------------------------------------------
		static std::map<std::string, Entry *> m_programs;
		//-------------------------------------------------------------------------
	};
