...
Water::Water(int pL, float pA, glm::vec3 pW, float pS, float pSuppression, float pChoppiness, glm::vec3 pWaterColor)
    : Node(BoundingBox())
{
    L = pL;
    A = pA;
    ...
    S = pS;
    suppression = pS;
    choppiness = pChoppiness;
    m_vWaterColor = pWaterColor;
