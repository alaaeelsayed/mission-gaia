...
void StateMainMenu::Update(float p_fDelta)
{
	...
	m_pProjectGaia->SetPos(screenSize.x / 2 - 250.0f, screenSize.y / 2 - 300.0f, 0.0f);
	m_pStartGame->SetPos(screenSize.x / 2 - 250.0f, screenSize.y / 2 - 100.0f, 0.0f);
	m_pQuitGame->SetPos(screenSize.x / 2 - 250.0f, screenSize.y / 2 + 100.0f, 0.0f);
	m_pLoading->SetPos(screenSize.x / 2 - 250.0f, screenSize.y / 2, 0.0f);
